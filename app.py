...
def run_script_1():
    ...
    try:
        # Crear la carpeta 'data' y sus subcarpetas si no existen
        ...
        os.makedirs(archivos_folder, exist_ok=True)
        os.makedirs(archivos_descomprimidos_folder, exist_ok=True)
